...
- (void)viewDidLoad {
    ...
    viewIsLoaded = YES;
    [self.chooseButton setTitle:[Language get:@"Choose" alter:nil] forState:UIControlStateNormal];
    [self.cancelButton setTitle:[Language get:@"Cancel" alter:nil] forState:UIControlStateNormal];
